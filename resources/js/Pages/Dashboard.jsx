...
export default function Dashboard() {
    const { totals, graphData = [] } = usePage().props;
    const isDark = useIsDarkMode();

    const chartColors = {
    bar: isDark ? "#60a5fa" : "#2563eb",       // blue-400 / blue-600
    grid: isDark ? "#1f2937" : "#e5e7eb",      // gpt-800 / gpt-200
    axis: isDark ? "#9ca3af" : "#6b7280",      // gpt-400 / gpt-500
