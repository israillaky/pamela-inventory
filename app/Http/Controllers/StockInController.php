...
class StockInController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return $this->handleException($request, $e, 'Unable to load Stock In list.');
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            // Create price snapshot for this Stock In (currently intentionally disabled)
            /*
            ...
            */
            ...
            return $this->handleException($request, $e, 'Unable to add Stock In.');
        }
    }
    ...
    public function update(Request $request, StockIn $stockIn)
    {
        try {
            ...
            // Keep the snapshot quantity in sync with the Stock In (currently intentionally disabled)
            /*
            ...
            */
            ...
            return $this->handleException($request, $e, 'Unable to update Stock In.');
        }
    }
    ...
    public function destroy(Request $request, StockIn $stockIn)
    {
        try {
            ...
            return $this->handleException($request, $e, 'Unable to delete Stock In.');
        }
    }
